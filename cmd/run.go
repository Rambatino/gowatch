...
func init() {
	...
	runCmd.Flags().StringSliceVarP(&IgnoreExtensions, "ignore-extensions", "ie", []string{}, "What file extensions to ignore. N.B. don't pass globs.")
	runCmd.Flags().StringSliceVarP(&IgnorePaths, "ignore-paths", "ip", []string{}, "What file paths to ignore. N.B. don't pass globs.")
